<template>
  <div class="TheIndex">
    ...
    <div class="TheIndex_Contact">
      <h2 class="TheIndex_Text TheIndex_Contact_Header">Contact <span class="TheIndex_Contact_Header_Jp">お問い合わせ</span></h2>
...
.TheIndex_Contact_Header{
  font-size: 60px;
  margin-bottom: 24px;
  /* font-weight: 500;f */
}
.TheIndex_Contact_Header_Jp{
  font-size: 32px;
  font-weight: 500;
}
